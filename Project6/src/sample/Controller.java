...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        V = new View(exact, euler, ieuler, rungeKutta,heun, draw);
    ...
    public void drawChart(){
        changeN();
        M.setRequiredCharts(V.isExactRequired(), V.isEulerRquired(), V.isIEulerRequierd(), V.isRungeKuttaRequired(),V.isHeunRequired());
    ...
    public void onTab2(){
        V = new View(exact2, euler2, ieuler2,rungeKutta2,heun2, drawError);
    }

    public void onTab3(){
        V = new View(exact3, euler3, ieuler3,rungeKutta3,heun3,truncationError);
    }
