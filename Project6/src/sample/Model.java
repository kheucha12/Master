...
public class Model {
    ...
    public void setRequiredCharts(boolean exact, boolean euler, boolean ieuler, boolean rungeKutta, boolean heun){
        exactRequired = exact;
        eulerRequired = euler;
    ...
    public ArrayList<Series<String, Number>> getFunctionSeries(){
        ...
        if (heunrequired){
            aproximationSeries.add(new Heun(X0, Y0, N, X).computeApproximation());
        }
    ...
    public ArrayList<Series<String, Number>> getErrorSeries (){
        ...
        if (heunrequired){
            errorSeries.add(computeError(new ExactMethod(X0, Y0, N, X), new Heun(X0, Y0, N, X)));
        }
    ...
    public ArrayList<Series<String, Number>> getTruncationErrorSeries (){
        ...
        if (heunrequired){
            errorSeries.add(computeTruncationError(new Heun(X0, Y0, N, X)));
        }
